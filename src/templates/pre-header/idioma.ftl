  ...
  <div class="dropdown">
    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
      ...
      <img style="width: 22px; margin-right: 5px;"
        src="${themeDisplay.getPathThemeImages()}/uninorte/icons/ico-idiomas.svg" />
      Idiomas
    </a>
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
      ...
      <a href="#" class="dropdown-item flag_link" data-lang="en" translate="no">
        <img height="20px" src="${themeDisplay.getPathThemeImages()}/uninorte/lang/en.png" class="pr-4" />inglés</a>

      <a href="#" class="dropdown-item flag_link" data-lang="fr" translate="no">
        <img height="20px" src="${themeDisplay.getPathThemeImages()}/uninorte/lang/fr.png" class="pr-4" />francés</a>

      <a href="#" class="dropdown-item flag_link" data-lang="de" translate="no">
        <img height="20px" src="${themeDisplay.getPathThemeImages()}/uninorte/lang/de.png" class="pr-4" />alemán</a>
    </div>
  </div>
</div>